...
public class ArtsmiaDAO {
	...
	public List<Adiacenza> getAdiacenze(Map<Integer, ArtObject> idMap) {
		String sql = "SELECT e1.object_id AS e1, e2.object_id AS e2, COUNT(*) as peso FROM exhibition_objects e1, exhibition_objects e2 "
				+ "WHERE e1.exhibition_id = e2.exhibition_id AND e1.object_id > e2.object_id GROUP BY e1.object_id, e2.object_id";
